  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="仓库" prop="warehouseId">
        <el-select v-model="queryParams.warehouseId" placeholder="选择仓库" @change="handleQuery" >
    ...
    <el-dialog :title="title" :visible.sync="open" width="1300px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-table :data="erpGoodsInventoryDetailList" :row-class-name="rowErpGoodsInventoryDetailIndex" ref="erpGoodsInventoryDetail">
          ...
          <el-table-column label="有效期（天）" prop="period" width="100" />
<!--          <el-table-column label="金重（g）" prop="actualGoldWeight"/>-->
<!--          <el-table-column label="银重（g）" prop="actualSilverWeight"  />-->
<!--          <el-table-column label="工费" prop="laborCost"  />-->
